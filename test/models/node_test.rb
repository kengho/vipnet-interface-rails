...
class NodesTest < ActiveSupport::TestCase
  ...
  test "normalize_vipnet_id" do
    vipnet_id1 = Node.normalize_vipnet_id("1A0E1234")
    vipnet_id2 = Node.normalize_vipnet_id("not looks like id at all")
    assert_equal("0x1a0e1234", vipnet_id1)
    assert_equal(false, vipnet_id2)
  end

  test "network" do
    network1 = Node.network("0x1a0e1234")
  ...
  test "accessips" do
    node1 = Node.new(vipnet_id: "0x1a0e1234")
    node2 = Node.new(vipnet_id: "0x1a0effff")
