class Message < ActiveRecord::Base
  ...
  # 15.02.16 17:47:12 AddAN: test2 ID=1A0E0298 Sign=1
  # удален пользователь; ID - номер пользователя
  # 15.02.16 22:41:12 DelAN: test2 ID=1A0E0298

  # заданы связи между АП, ТК и П; AN - номер пользователя; UG - номер коллектива; NO - номер АП
  # 15.02.16 17:47:12 AddUL: AN=1A0E0298 UG=1A0E02BA NO=1A0E02C6
  # удалены связи между АП, ТК и П; AN - номер пользователя; UG - номер коллектива; NO - номер АП
  # 15.02.16 22:41:12 DelUL: AN=1A0E0298 UG=1A0E02BA NO=1A0E02C6 R=1
  ...
  # 15.02.16 22:41:12 DelUN: test2 UG=1A0E02BA NO=1A0E02C6
  ...
  # 15.02.16 17:47:12 AddUN: test2 ID=1A0E02BA NO=1A0E02C6
