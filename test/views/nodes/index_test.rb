class NodesControllerIndexTest < ActionController::TestCase
  ...
  test "vipnet version substitution" do
    ...
    id8 = nodes(:version_substitution8).id
    id9 = nodes(:version_substitution9).id
    ...
    assert_equal("4", css_select("#node-#{id4}__vipnet-version").children.text)
    assert_equal("4", css_select("#node-#{id5}__vipnet-version").children.text)
    ...
    assert_equal("3.1", css_select("#node-#{id8}__vipnet-version").children.text)
    assert_equal("4", css_select("#node-#{id9}__vipnet-version").children.text)
  end
