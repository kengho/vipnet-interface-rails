...
class NodesControllerIndexTest < ActionController::TestCase
  ...
  test "vipnet version substitution" do
    ...
    node1 = Node.new(
      ...
      version: { "summary" => "3.0-670" }
    )
    node2 = Node.new(
      vipnet_id: "0x1a0e0002",
      name: "client2",
      network_id: networks(:network1).id,
      version: { "summary" => "3.2-672" }
    )
    node3 = Node.new(
      vipnet_id: "0x1a0e0003",
      name: "client3",
      network_id: networks(:network1).id,
      version: { "summary" => "0.3-2" }
    )
    node4 = Node.new(
      vipnet_id: "0x1a0e0004",
      name: "client4",
      network_id: networks(:network1).id,
      version: { "summary" => "4.20-0" }
    )
    node5 = Node.new(
      vipnet_id: "0x1a0e0005",
      name: "client5",
      network_id: networks(:network1).id,
      version: { "summary" => "4.20-1" }
    )
    node6 = Node.new(
      vipnet_id: "0x1a0e0006",
      name: "client6",
      network_id: networks(:network1).id,
      version: { "summary" => "3.2-673" }
    )
    node7 = Node.new(
    ...
    node8 = Node.new(
      ...
      name: "client8",
      network_id: networks(:network1).id,
      version: { "summary" => "3.0-671" }
    )
    node9 = Node.new(
      vipnet_id: "0x1a0e0009",
      name: "client9",
      network_id: networks(:network1).id,
      version: { "summary" => "4.30-0" }
    )
    node1.save!
    node2.save!
    node3.save!
