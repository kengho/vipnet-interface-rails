...
class IPv4Test < ActionController::TestCase
  ...
  test "should convert IPv4 to u32" do
    assert_equal(3232235521, IPv4::u32("192.168.0.1"))
    assert_equal(4294967295, IPv4::u32("255.255.255.255"))
    assert_not IPv4::u32("256.256.256.256")
  end

  test "should convert u32 to IPv4" do
    assert_equal("192.168.0.1", IPv4::ip(3232235521))
    assert_equal("255.255.255.255", IPv4::ip(4294967295))
    assert_not IPv4::ip(4294967296)
  end
  ...
  test "should calculate bounds by cidr or range" do
    assert_equal([3232235520, 3232235775], IPv4::u32_bounds("192.168.0.0/24"))
    assert_equal([3232235520, 3232235775], IPv4::u32_bounds("192.168.0.100/24"))
    assert_equal([3232235521, 3232235521], IPv4::u32_bounds("192.168.0.1/32"))
    assert_equal([3232235521, 3232235522], IPv4::u32_bounds("192.168.0.1-192.168.0.2"))
    assert_equal([0, 4294967295], IPv4::u32_bounds("0.0.0.0-255.255.255.255"))
